...
<Accordion title="Backend — FastAPI + AI agent + Neo4j client">
### `app/main.py`
...
<Accordion title="Frontend — Next.js + Chakra UI v3 + NVL">
### `app/page.tsx`
...
<Accordion title="Cypher — Schema constraints + GDS projections">
### `schema.cypher`
...
<Accordion title="Data — Ontology, fixtures, and documents">
