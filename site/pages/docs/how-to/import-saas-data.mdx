...
<Accordion title="Notion — Internal integration token">
...
<Accordion title="Jira — API token + Atlassian email">
...
<Accordion title="Slack — Bot OAuth token">
...
<Accordion title="Gmail / Google Calendar — Google OAuth 2.0">
...
<Accordion title="Salesforce — OAuth 2.0 connected app">
...
<Accordion title="Google Workspace — Google OAuth 2.0 (Drive, Activity, Calendar, Gmail)">
...
<Accordion title="Linear — Personal API key">
...
<Accordion title="Claude Code — No setup required (local files)">
...
<Accordion title="Claude AI — No setup required (export file)">
...
<Accordion title="ChatGPT — No setup required (export file)">
