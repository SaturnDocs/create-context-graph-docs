...
<Warning title="Python version errors">
...
<Tip title="Check for session data">
...
<Warning title="API key required for chat">
...
<Tip title="Customizing re-imports via `.env`">
...
<Note title="Session deduplication">
...
<Info title="Suggested next tutorial">
